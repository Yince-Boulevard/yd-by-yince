...
const pages = [
  ...
  },
  {
    path: "pages/tip/tip",
    style: {
      navigationBarTitleText: "其他小组"
    }
  }
];
const globalStyle = {
  navigationBarTextStyle: "black",
  navigationBarTitleText: "YICNCE",
  navigationBarBackgroundColor: "#c1380f",
...
const S = true, b = "mp-weixin", A = I(define_process_env_UNI_SECURE_NETWORK_CONFIG_default), C = b, P = I('{"address":["127.0.0.1","192.168.0.103","192.168.60.1","192.168.19.1"],"servePort":7000,"debugPort":9000,"initialLaunchType":"remote","skipFiles":["<node_internals>/**","C:/Program Files/HBuilderX/plugins/unicloud/**/*.js"]}'), T = I('[{"provider":"aliyun","spaceName":"yince01","spaceId":"mp-3140dfa5-4cb8-4295-a491-b9c71e57ea65","clientSecret":"EMNPbd7Gv2xBMfDbYf/yoA==","endpoint":"https://api.next.bspapp.com"}]') || [];
let O = "";
try {
  O = "__UNI__367175D";
} catch (e2) {
