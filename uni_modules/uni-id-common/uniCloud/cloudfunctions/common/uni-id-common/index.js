...
class E {
	constructor({
		...
		this.uid = null, this.userRecord = null, this.userPermission = null, this.oldToken = null, this.oldTokenPayload =
			null, this.uniId = e, this.config = this.uniId._getConfig(), this.clientInfo = this.uniId._clientInfo, this
			.checkConfig()
	}
	checkConfig() {
		const {
...
class x {
	constructor({
		...
		}(e) : t, this._config = n, this.config = this._getOriginConfig(), this.interceptorMap = new Map, w.hasFile(
